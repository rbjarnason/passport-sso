...
class AudkenniStrategy extends OpenIDConnectStrategy {
  ...
  authenticate(req, res, options) {
    // Parse cookies using cookie-parser middleware within this strategy
    cookieParser()(req, res, () => {
      ...
      if (!req.query || !req.query.code) {
        ...
        if (codeVerifier) {
          ...
          console.log(
            "AudkenniStrategy: Code verifier retrieved from cookie:",
  ...
  authorizationParams(req, res, options) {
    ...
    if (this._pkceMethod) {
      ...
      console.log(`AudkenniStrategy: PKCE challenge generated:`, {
        verifier,
        challenge,
      ...
      console.log(
        `AudkenniStrategy: PKCE challenge generated using ${this._pkceMethod} method. Verifier stored in cookie.`
      );
    }
