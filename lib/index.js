...
class AudkenniStrategy extends OpenIDConnectStrategy {
  ...
  authenticate(req, options) {
    ...
    if (!req.query || !req.query.code) {
      ...
      if (codeVerifier) {
        ...
        console.log("AudkenniStrategy: Code verifier retrieved from cookie:", options.code_verifier);
      } else {
  ...
  authorizationParams(req, res, options) {  // Accept res as a parameter
    ...
    console.log("AudkenniStrategy: Final authorization params:", JSON.stringify(params, null, 2));
    return params;
  }
  ...
  tokenParams(options) {
    ...
    if (options.code_verifier) {
      ...
      console.log("AudkenniStrategy: Code verifier added to token params:", params.code_verifier);
    } else {
      console.warn(
