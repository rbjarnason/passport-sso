...
class AudkenniStrategy extends OpenIDConnectStrategy {
  ...
  authenticate(req, options) {
    ...
    if (!req.query || !req.query.code) {
      ...
      this.getVerifierFromRedis(req, "pkceCodeVerifier")
        .then((codeVerifier) => {
          console.log(
          ...
          if (codeVerifier) {
            ...
            this.clearVerifierFromRedis(req, "pkceCodeVerifier")
              .then(() => {
                console.log(
  ...
  authorizationParams(options) {
    ...
    if (this._pkceMethod) {
      ...
      setTimeout(async () => {
        ...
        try {
          await this.storeVerifierInRedis(
            this._req,
            "pkceCodeVerifier",
            verifier
          );
          ...
          console.error(
            `AudkenniStrategy: Error storing PKCE verifier in Redis: ${err}`
          );
          throw err;
        }
